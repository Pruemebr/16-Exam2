...
Authors: David Mutchler, Dave Fisher, Matt Boutell, Amanda Stouder,
         their colleagues and Bryce Pruemer.  April 2018.
...
def main():
    ...
    p3 = Person(19)
    print('Test celebrate_birthday')
    print('expected: 20 Happy birthday!')
    print('actual:', p3.celebrate_birthday(), p3.get_age())
    print()

    # Test celebrate_birthdays
    p4 = Person(33)
    print('Test celebrate_birthdays')
    print('expected: 34 Happy birthday! 35 Happy birthday')
    print('actual:', p4.celebrate_birthdays(2), p4.get_age())
    print()

    # Test colder_person
    p5 = Person(50)
    print('Test older_person')
    print('expected: New persons age is 100')
    newperson = p5.older_person()
    print('actual:''New persons age is', newperson.get_age())
    print('other person is', p5.get_age())
